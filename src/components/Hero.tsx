    ...
    <section className="relative min-h-screen flex flex-col justify-center px-6 lg:px-8 overflow-hidden pt-20">
      ...
      <div className="max-w-[100rem] w-full mx-auto z-10 flex flex-col xl:flex-row items-center justify-between gap-16 xl:gap-24">
        ...
        <motion.div
          ...
          className="flex items-center justify-end w-full max-w-xl xl:max-w-[45rem] mt-12 xl:mt-0 z-10"
        >
          <img src={logo} alt="Logo Jornada Acadêmica" className="w-full h-auto object-contain drop-shadow-2xl scale-125 xl:scale-[1.35] transform-gpu origin-center xl:origin-right xl:translate-x-12" />
        </motion.div>
