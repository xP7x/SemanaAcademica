...
const mockSpeakersList: Speaker[] = [
  ...
  { id: 11, name: "Dênis Selau", role: "Fisioterapeuta UFRGS • Residente em Fisioterapia Cardiovascular HCPA", summary: "Atuação no cuidado e reabilitação cardiopulmonar de alta densidade tecnológica no HCPA.", areas: ["Fisioterapia cardiovascular", "Mesa redonda"], photo: "/images/convidados/Foto Denis Selau.jpg", photoPosition: "center 20%" },
  ...
  { id: 29, name: "Luiz Fernando Alvarenga", role: "Professor & Fisioterapeuta • Mesa: 'Entrei na Fisio, e agora?'", areas: ["Mesa redonda", "Demais áreas"] },
  { id: 30, name: "Laura Zandavalli", role: "Fisioterapeuta • Convidada das Mesas-redondas", areas: ["Mesa redonda", "Demais áreas"] },
  ...
  { id: 35, name: "João Almeida", role: "Fisioterapeuta • Convidado das Mesas-redondas", areas: ["Mesa redonda", "Demais áreas"] },
  { id: 36, name: "Matheus Seidel", role: "Fisioterapeuta • Convidado das Mesas-redondas", areas: ["Mesa redonda", "Demais áreas"] },
  { id: 37, name: "Filipe Schedler", role: "Fisioterapeuta • Convidado das Mesas-redondas", areas: ["Mesa redonda", "Demais áreas"] },
