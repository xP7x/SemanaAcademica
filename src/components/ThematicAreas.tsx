...
const mockSpeakersList: Speaker[] = [
  ...
  { id: 31, name: "Victória Dames", role: "Graduanda em Fisioterapia • UFRGS", summary: "Estudante do último semestre de graduação de Fisioterapia da UFRGS.", areas: ["Mesa redonda", "Demais áreas"] },
  ...
  { id: 34, name: "Angela Ghisleni", role: "Professora & Fisioterapeuta • Mesa: Redes Sociais", areas: ["Mesa redonda", "Demais áreas"] },
